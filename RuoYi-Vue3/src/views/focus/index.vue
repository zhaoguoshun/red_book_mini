<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="被关注id" prop="quiltUserId">
        <el-input
            v-model="queryParams.quiltUserId"
            placeholder="请输入被关注id"
            clearable
            size="small"
            @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="focusList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="被关注id" align="center" prop="quiltUserId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="被关注id" prop="quiltUserId">
          <el-input v-model="form.quiltUserId" placeholder="请输入被关注id" />
        </el-form-item>
      </el-form>
...
<script>
import { listFocus, getFocus, delFocus, addFocus, updateFocus, exportFocus } from "@/api/system/focus";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除关注编号为"' + ids + '"的数据项?', "警告", {
