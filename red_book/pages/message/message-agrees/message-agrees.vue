	...
	<view class="container">
		...
		<tui-navigation-bar backgroundColor="#fff" :isFixed="false" :isOpacity="false">
			<view class="nav">
				...
				<view style="margin-left: 50%;">赞</view>
			</view>
		</tui-navigation-bar>
				...
				<tui-list-cell :lineLeft="false" v-for="(item, index) in dataList" :key="index">
					<view class="tui-item-box">
						<view class="tui-msg-box">
							<image :src="'http://localhost:8083'+item.avatar" class="tui-msg-pic" mode="aspectFill"
							...
							<view class="tui-msg-item" @click="getImg(item.detailId)" v-else>
								<view class="tui-msg-name">{{ item.nickname }}</view>
								<view class="tui-msg-type">
									<view  class="tui-msg-type-item">点赞您的作品</view>
	...
	export default {
		...
		methods: {
			...
			getAllAgreeAndCollection() {
				...
				getAllAgreeAndCollection().then(res => {
                    console.log(res)
					res.data.forEach((e) => {
						e.createDate = timeAgo(e.createTime)
