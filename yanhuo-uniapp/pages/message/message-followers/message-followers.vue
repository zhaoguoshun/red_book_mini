	...
	<view class="container">
		<tui-navigation-bar backgroundColor="#fff" :isFixed="false" :isOpacity="false">
			<view class="nav">
				...
				<view style="margin-left: 50%;">新增关注</view>
			</view>
		</tui-navigation-bar>
				...
				<tui-list-cell :lineLeft="false" v-for="(item, index) in dataList" :key="index">
					<view class="tui-item-box">
						<view class="tui-msg-box" @click="getUserInfo(item.uid)">
							<image :src="'http://localhost:8083'+item.avatar" class="tui-msg-pic" mode="aspectFill" :lazy-load='true' />
						...
						<view class="tui-msg-right">
							...
							<tui-button v-if="item.isfollow" @click="clearFollow(item.userId,index)" type="gray" height="50rpx"
								size="22" width="100rpx" shape="circle" plain>已关注</tui-button>

							<tui-button v-else @click="follow(item.userId,index)" type="danger" height="50rpx" size="22"
